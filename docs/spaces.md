...
Before reading this, it is suggested to go through the 2 functions: createSpaces and checkSpaces from database.go.
...
This document explains the purpose and behavior of the CreateSpace and DeleteSpace methods. These methods are responsible for managing records in the spaces table.
...
In case a duplicate space name is given, Postgres rejects it because spaceName is a primary key.
